...
{assistantName && <button className='min-w-[300px] h-[60px] mt-[30px] text-black fonr-semibold cursor-pointer bg-white rounded-full text-[19px]' disabled={loading} onClick={()=>{
